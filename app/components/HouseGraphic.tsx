export default function HouseGraphic({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <rect x="-100" y="320" width="510" height="135" fill="#DEDAD2" />
      <rect x="-100" y="350" width="495" height="105" fill="#C8C4BC" />
      <line x1="-100" y1="375" x2="410" y2="375" stroke="#B0B0A8" strokeWidth="2" />
      <line x1="-100" y1="398" x2="410" y2="398" stroke="#B0B0A8" strokeWidth="2" />
      <line x1="-100" y1="421" x2="410" y2="421" stroke="#B0B0A8" strokeWidth="2" />
      <line x1="-100" y1="444" x2="410" y2="444" stroke="#B0B0A8" strokeWidth="2" />
      <line x1="155" y1="350" x2="155" y2="455" stroke="#B0B0A8" strokeWidth="2" />
      <polygon points="-100,320 410,320 410,310 -100,310" fill="#1A1A1A" />
